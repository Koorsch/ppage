import KooButton from "./kooButton";

export default function KooNav() {
  return (
          <nav className="w-full sticky top-0 bg-slate-700 border-b border-slate-600 shadow-lg inline-flex flex-wrap gap-y-4 p-2 justify-end text-2xl">
            <div className="inline-flex flex-wrap justify-end self-center gap-2">
              <KooButton href="#hero" withIcon icon={<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-arrow-up-square-fill" viewBox="0 0 16 16"><path d="M2 16a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2zm6.5-4.5V5.707l2.146 2.147a.5.5 0 0 0 .708-.708l-3-3a.5.5 0 0 0-.708 0l-3 3a.5.5 0 1 0 .708.708L7.5 5.707V11.5a.5.5 0 0 0 1 0z"/></svg>}>
                Back to top
              </KooButton>
              ...
              <div className="inline-flex gap-x-6 pl-4 pr-2 items-center">
                ...
                <a href="https://github.com/Koorsch" target="_blank" className="hover:invert-50">
