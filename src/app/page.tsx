    ...
    <main className="min-h-screen w-auto">
      ...
      <KooSection id="cv" color="bg-slate-600">
        <div className="grid grid-flow-row md:grid-flow-col gap-x-12 gap-y-6 pb-4">
          ...
          <KooButton moreStyling="w-fit">Print CV</KooButton>
          </div>
        </div>
        ...
        <div className="flex flex-col pl-2 pt-4 max-w-[90%]">
          <div className="grid grid-flow-col items-center pb-4">
          ...
          <p className="">An all-round education where I was introduced to many conects and techniques to springboard me into the world of tech.</p>
        </div>

      </KooSection>
      <KooSection id="projects" color="bg-slate-700">
        <div>
          <h2>Hemlo!</h2>
        </div>
      </KooSection>
      <KooSection id="about" color="bg-slate-800">
        <div>
          <h2>Hemlo!</h2>
        </div>
      </KooSection>
